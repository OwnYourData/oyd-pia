...
public class RepoResource {
    ...
    @CrossOrigin
    @PreAuthorize("hasRole('ROLE_ADMIN') OR @repoSecurityService.hasPermission(authentication,#identifier+':read')")
    ...
    @Timed
    @CrossOrigin
    @PreAuthorize("hasRole('ROLE_ADMIN') OR @repoSecurityService.hasPermission(authentication,#identifier+':write')")
    ...
    @Timed
    @CrossOrigin
    @PreAuthorize("hasRole('ROLE_ADMIN') OR @repoSecurityService.hasPermission(authentication,#identifier+':update')")
    ...
    @Timed
    @CrossOrigin
    @PreAuthorize("hasRole('ROLE_ADMIN') OR @repoSecurityService.hasPermission(authentication,#identifier+':delete')")
