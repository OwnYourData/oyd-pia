package eu.ownyourdata.pia.web.websocket;

import eu.ownyourdata.pia.security.SecurityUtils;
import eu.ownyourdata.pia.web.websocket.dto.ActivityDTO;
...
import static eu.ownyourdata.pia.config.WebsocketConfiguration.IP_ADDRESS;
